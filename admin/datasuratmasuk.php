                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th width="25%">Nomor Surat Tugas</th>
                            <th width="18%">Sifat/Jenis Tugas</th>
                            <th width="18%">Tempat Berangkat</th>
                            <th width="18%">Nomor Berkas</th>
                            <th width="18%">Alamat Penerima</th>
                            <th width="10%">Tanggal LHP</th>
