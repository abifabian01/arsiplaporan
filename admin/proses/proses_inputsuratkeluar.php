...
if (
	!($nomor_suratkeluar == '') and !($tanggalkeluar_suratkeluar  == '') and !($nama_nip  == '') and !($sppd   == '') and !($tanggalsurat_suratkeluar == '')   and !($jenis_tugas == '') and !($alamat == '') and !($operator == '') and !($tanggal_entry == '') and
	...
	$sql = "INSERT INTO tb_suratkeluar(nomor_suratkeluar, tanggalkeluar_suratkeluar, nama_nip, sppd, tanggalsurat_suratkeluar, jenis_tugas, alamat, operator, tanggal_entry)
				values ('$nomor_suratkeluar', '$tanggalkeluar_suratkeluar', '$nama_nip', '$sppd', '$tanggalsurat_suratkeluar', '$jenis_tugas', '$alamat', '$operator', '$tanggal_entry')";
