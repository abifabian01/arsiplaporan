...
<head>
  ...
  <title>Arsip Surat Inspektorat Kabupaten Rote Ndao</title>
                ...
                <div class="row">
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <br><br>
                      <center>
                        <h1><b>Hi, <?php echo $_SESSION['nama']; ?></b></h1>
                      </center>
                      <br><br>
                    </div>
                  </div>
                  ...
                  <form action="ambilnomor.php" name="ambilnomor" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="animated flipInY col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="tile-stats">
                        ...
                        <div class="count">
                          <center>Nomor Surat Keluar Berikutnya :</center>
                        </div>
                        <div class="count">
                          <center><?php echo "$nomorbaru" ?></center>
                        </div>
                        <center>
                          <h3>Terakhir Diperbarui Pada :<?php echo "$update" ?></h3>
                        </center>
                        <div class="count"><a href="../admin/file/kode_klasifikasi_surat.xlsx">
                            <center>Lihat Kode Klasifikasi Surat</center>
                          </a></div>
