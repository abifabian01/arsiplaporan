  ...
  <div id="myDiv">
          ...
          <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">ARSIP LAPORAN HASIL PEMERIKSAAN <span class="logo-dec">INSPEKTORAT KABUPATEN ROTE NDAO</span></a>
              </div>
              <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                  <li class="active"><a href="#main-header">Beranda</a></li>
                  <li class=""><a href="#feature">Tentang</a></li>
                  <li class=""><a href="#portfolio">Pembuat</a></li>
                  <ul class="nav navbar-nav navbar-right">
                    <li class="">
          ...
          <div class="container">
            <div class="row">
              <div class="banner-info text-center wow fadeIn delay-05s">
                ...
                <div class="logo">
                  <img src="img/rotendao.png" alt="" />
                </div>
                <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN LAPORAN HASIL PEMERIKSAAN</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">INSPEKTORAT KABUPATEN ROTE NDAO</span></h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt8">Website ini berguna untuk pengarsipan Laporan Hasil Pemeriksaan di Kantor Inspektorat Kabupaten Rote Ndao</p>
            <p></p>
            <p>...</p>
          ...
          <div class="col-md-12 col-sm-4 col-xs-12">
            <div class="wrap-item text-center">
              <div class="item-img">
                <img src="img/arsip1.png">
              </div>
              <h3 class="pad-bt15">E-Inventory</h3>
    ...
    <section id="portfolio" class="section-padding wow fadeInUp delay-05s">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="service-title pad-bt15">PEMBUAT</h2>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/magangrote.jpg" class="img-responsive">
              <figcaption>
                <h2>TIM MAGANG KABUPATEN ROTE NDAO</h2>
                <p>"STIKOM UYELINDO KUPANG"</p>
    ...
    <!---->
    <!---->
    <section id="testimonial" class="wow fadeInUp delay-08s">
        ...
        <div class="row">
          <div class="testimonial-item">
            <ul class="bxslider">
              <li>
                <blockquote>
                  <img src="img/gear.png" class="img-responsive">
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; STIKOM UYELINDO KUPANG. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
